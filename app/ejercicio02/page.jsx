...
export const Ejercicio02 = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
       <h1 className='bg-violet-200  rounded-2xl hover:bg-purple-300  hover:text-white text-violet-800 '>DFA QUE ACEPTA TODAS LAS CADENAS QUE CONTENGAN LA CADENA AABB</h1>
      <input
        type="text"
        placeholder="Entrada"
        value={palabra}
